...
SECRET_KEY = 'django-insecure-rn@^c5l4jj!ltl+i^_$h#09sbf9ms0x92&qk^q3kj)ly*0_2-8'
...
ROOT_URLCONF = 'bixdata_backend.urls'

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': [BASE_DIR / 'bixdata_backend' / 'bixdata_backend_app' / 'templates'],  # Add this line
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'bixdata_backend.wsgi.application'
